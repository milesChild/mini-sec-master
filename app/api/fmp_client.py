...
def get_company_data_for_ticker(ticker: Union[str, float, None]) -> dict:
    """
    ...
    try:
        ...
        try:
            ...
            raise RuntimeError("API request failed: invalid JSON response")
        ...
        raise RuntimeError(f"Failed to connect to FMP API: {str(e)}")
